...
ggplot(performance_data_k2, aes(x=num_threads, y=processing_speed_up, color="processing")) + 
  geom_line() + geom_point() +
  ylab("Speed Up (compared to threads)") + 
  xlab("Number of threads") + 
...
Plot 2 represents the processing speed up, compute speed up and compute speed up plotted against number of threads when K value is 2. It is clear that addition of more threads will give reduced performance as JVM will schedule multiple threads to the same physical core so for best performance threads should be equal to number of cores. (Answer to point 3 in assignment)
